...
<figcapthin> Figure 14: Left: a regularr transformer block. Right: a transformer block in prefix-tuning approach. </figcaption>
...
Another advantage of CoT prompting is that it can help LLMs to solve more complex and nuanced problems. By breaking down complex problems into smaller, more manageable steps, CoT prompting can make it easier for LLMs to solve them accurately.
