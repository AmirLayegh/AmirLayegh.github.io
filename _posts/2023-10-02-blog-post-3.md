...
Unlike traditional supervised learning, which trains a model to take in an input $x$ and predict an output $y$ given $x$ as $P(y|x)$, prompt-based learning is based on language models that model the probability of text directly [^1].
