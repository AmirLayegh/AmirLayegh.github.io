...
As illusterated in Figure 4, there are some solved examples to improve the response of LLM which characterizes this prompting approach as *few-shot Prompting*.
