...
Another option to automatically generate optimal prompts is to incorporate knowledge into the prompt. This injected knowledge can help the language model to predict more accurately. In this regard, [Liu et al.](https://arxiv.org/pdf/2110.08387.pdf) proposed an approach that develops generated knowledge prompting, which consists of generating knowledge from a language model and then providing the knowledge as additional input when answering a question. The first stage involves knowledge generation, where a language model is employed to generate knowledge statements conditioned on the question ($P(k|q)$). The second step is knowledge integration, where the generated knowledge statement is integrated into the question (prompt) and is fed to the language model (as an inference model) to predict the answer (See Figure 11 taken from [Liu et al.](https://arxiv.org/pdf/2110.08387.pdf)). This process can be formulated as follows:
