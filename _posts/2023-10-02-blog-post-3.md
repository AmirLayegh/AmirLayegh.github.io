...
- **Instruction**: indicates the specific task that LLM should perform
- **Context**: invlolves extra context such as solved examples or additional context that align the model to better responses
- **Input Data**: shows the input data that we want to perform the task on 
- **Output Indicator**: illustrates the format of desired output
